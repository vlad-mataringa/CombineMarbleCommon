...
2. Enter `https://github.com/vlad-mataringa/CombineMarbleCommon.git`

Or you can add the following dependency to your `Package.swift`:

```swift
.package(url: "[https://github.com/vlad-mataringa/CombineMarbleCommon](https://github.com/vlad-mataringa/CombineMarbleCommon)", from: "1.0.0")
